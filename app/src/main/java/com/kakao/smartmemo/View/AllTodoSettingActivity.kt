...
class AllTodoSettingActivity: AppCompatActivity(), AllTodoSettingContract.View {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // Toolbar달기
        myToolbar = findViewById(R.id.todosettings_toolbar)
        ...
        val todostub_time = stub_alarm_time_settings
        val view_time = todostub_time.inflate()
        todostub_time.visibility = GONE

        val todostub_location = stub_alarm_location_settings
        ...
        alarmswitch_time_settings = switch_time_settings
        alarmswitch_location_settings = switch_location_settings
        ...
        savebtn = this.findViewById(R.id.saveTodoAlarmButtonSettings)
