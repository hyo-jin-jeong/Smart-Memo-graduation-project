...
data class TodoData(
    var title: String, var groupName: String = "", var groupId: String, var timeAlarmId: String = "", var setTimeAlarm: Boolean = false, var timeDay: String = "", var timeDate: String = "", var timeTime: String = "", var timeAgain: String = ""
